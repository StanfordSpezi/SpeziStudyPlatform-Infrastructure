#!/usr/bin/env python3
"""End-to-end integration checks for authentication and routing."""
...
class TestIntegration(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        if not cls.CONFIG.base_url:
            cls.CONFIG.base_url = "https://localhost"
...
def main(argv=None):
    ...
    parser.add_argument(
        "--base-url",
        help="Root URL for the ingress/Traefik endpoint (default: https://localhost).",
    )
    parser.add_argument(
        "--username",
        default="testuser",
